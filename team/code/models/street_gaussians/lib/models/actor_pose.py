...
class ActorPose(nn.Module):      
    def __init__(self, tracklets, tracklets_world, tracklet_timestamps, camera_timestamps, obj_info):
        ...
        tracklets_world = torch.from_numpy(tracklets_world).float().cuda()
        ...
        self.input_trans_world = tracklets_world[..., 1:4] # [num_frames, max_obj, [x, y, z]]
        self.input_rots_world = tracklets_world[..., 4:8] # [num_frames, max_obj, [qw, qx, qy, qz]]
