...
def download_file_from_oss(oss_bucket, oss_path, local_path, extra_str=""):
    ...
    """
    oss_endpoint = os.getenv("OSS_ENDPOINT", "http://oss-cn-wulanchabu.aliyuncs.com")
    ...
    # ossutil -e $OSS_ENDPOINT -i $OSS_ACCESS_KEY_ID -k $OSS_ACCESS_KEY_SECRET -r --parallel 8 cp -f "oss://cloudsim-ci-sh/sim_engine/artificially_created_scenes/c-f560ab8e-0f35-31fe-8e57-36a00fe39dd9/trained_model_202509021553/3dgs_model.tgz" ./
...
def upload_object_to_oss(oss_bucket, local_path, oss_path, extra_str=""):
    ...
    # ossutil -e $OSS_ENDPOINT -i $OSS_ACCESS_KEY_ID -k $OSS_ACCESS_KEY_SECRET -r --parallel 8 cp -f ./3dgs_model.tgz "oss://cloudsim-ci-sh/sim_engine/artificially_created_scenes/c-f560ab8e-0f35-31fe-8e57-36a00fe39dd9/trained_model_202509021553/3dgs_model.tgz"
