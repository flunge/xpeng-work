...
def upload_object_to_oss(oss_bucket, local_path, oss_path, extra_str=""):
    ...
    # ossutil -e http://oss-cn-wulanchabu.aliyuncs.com -i OSS_ACCESS_KEY_ID_REDACTED -k OSS_ACCESS_KEY_SECRET_REDACTED -r --parallel 8 cp -f ./3dgs_model.tgz "oss://cloudsim-ci-sh/sim_engine/artificially_created_scenes/c-f560ab8e-0f35-31fe-8e57-36a00fe39dd9/trained_model_202509021553/3dgs_model.tgz"
