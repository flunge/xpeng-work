...
config_name="train_v3"
gpu_num="8"
node_num="8"
main_process_port="29601"

fuyao deploy --gpu-type=A100  --volume=adc-sim --queue=adc-sim --release\
             --site=fuyao_b1_prod2 --label "nvfixer_${config_name}_${main_process_port}" \
    ...
    bash /workspace/yangxh7@xiaopeng.com/codes/3dgs/models/nvfixer/deploy/run_train_nvfixer_ngpu.sh "$gpu_num" "$node_num" "$main_process_port" "$config_name"
