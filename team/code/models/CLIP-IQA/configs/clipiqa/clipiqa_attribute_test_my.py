...
model = dict(
    ...
    generator=dict(
        ...
        # test degradation attributes (Quality / Sharpness / Noisiness)
        classnames=[
            # ['Good photo.', 'Bad photo.'],
            ['Sharp photo.', 'Blurry photo.'],
            ['Clean photo.', 'Messy photo.'],       # 整洁感
            ['Perfect photo.', 'Degraded photo.'],  # 恢复感
            # ['Noisy photo.', 'Clean photo.'],
            # ['Articfact-free','Articfact'],          # 人为痕迹
            # ['Natural photo.', 'Synthetic photo.'],     # 自然感
            # ['Detailed photo.', 'Flat photo.'],
            # ['High quality photo.', 'Low quality photo.'], # 对比度
            # ['Realistic photo.', 'Unrealistic photo.'], # 真实感
        ]),

        # test all degradation attributes
        # classnames=[
        #     ['Good photo.', 'Bad photo.'],
