...
from data_mining.Mask2Former.mask2former.utils.misc import is_dist_avail_and_initialized
...
class VideoSetCriterion(nn.Module):
    ...
    def loss_masks_proto(self, src_masks, target_masks, num_masks):
        ...
        losses = {
            "loss_mask_proto": sigmoid_ce_loss_jit(point_logits, point_labels, num_masks),
            "loss_dice_proto": dice_loss_jit(point_logits, point_labels, num_masks),
        }
