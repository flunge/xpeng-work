...
def add_maskformer2_config(cfg):
    ...
    # SAM adapter backbone
    cfg.MODEL.SAM_ADAPTER = CN()
    cfg.MODEL.SAM_ADAPTER.NAME = "vitl"
    cfg.MODEL.SAM_ADAPTER.VIT_WEIGHT = "sam_vit_l_0b3195.pth"
    cfg.MODEL.SAM_ADAPTER.FREEZE_VIT = True
    cfg.MODEL.SAM_ADAPTER.FINETUNE = False
    cfg.MODEL.SAM_ADAPTER.FINETUNE_INDEXES = [0, ]
    cfg.MODEL.SAM_ADAPTER.WITH_CP = True
