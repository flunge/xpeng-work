  ...
  int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(at::typeMetaToScalarType(fmap1.dtype()), "corr_forward_kernel", ([&] {
  ...
  int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(at::typeMetaToScalarType(fmap1.dtype()), "corr_backward_kernel", ([&] {
  ...
  torch::Tensor net, torch::Tensor coords, int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(at::typeMetaToScalarType(net.dtype()), "patchify_forward_kernel", ([&] {
  ...
  int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(at::typeMetaToScalarType(net.dtype()), "patchify_backward_kernel", ([&] {
