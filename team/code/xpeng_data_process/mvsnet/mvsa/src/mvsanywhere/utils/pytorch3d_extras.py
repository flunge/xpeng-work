...
_marching_cubes_dir = os.path.join(os.path.dirname(_current_dir), 'tools', 'marching_cubes')
marching_cubes_impl = load(
    name="ext",
    sources=[
        os.path.join(_marching_cubes_dir, "ext.cpp"),
        os.path.join(_marching_cubes_dir, "marching_cubes_cpu.cpp"),
        os.path.join(_marching_cubes_dir, "marching_cubes.cu"),
    ],
    verbose=True,
)
