...
from mvsnet.mvsa.src.mvsanywhere.utils.generic_utils import upsample
...
class ResnetMatchingEncoder(nn.Module):
    ...
    def __init__(
        ...
        if pretrained and num_layers == 18 and antialiased:
            import os
            pretrained_path = '/workspace/group_share/adc-sim/users/zf/recon_pretrained_models/resnet18_lpf4_finetune-8cc58f59.pth'
            if os.path.exists(pretrained_path):
                encoder = resnets[num_layers](pretrained=False)
