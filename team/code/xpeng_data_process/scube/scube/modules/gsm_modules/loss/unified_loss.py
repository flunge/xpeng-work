...
class UnifiedLoss(nn.Module):
    def __init__(self, hparams):
        ...
        directory = "/root/.cache/torch/hub/checkpoints/"
        if not os.path.exists(directory):
            os.makedirs(directory, exist_ok=True)
        shutil.copy("/workspace/group_share/adc-sim/users/dsc/scube_ckpt/vgg16-397923af.pth", "/root/.cache/torch/hub/checkpoints/vgg16-397923af.pth")
        shutil.copy("/workspace/group_share/adc-sim/users/dsc/scube_ckpt/alexnet-owt-7be5be79.pth", "/root/.cache/torch/hub/checkpoints/alexnet-owt-7be5be79.pth")
