...
from diff_gaussian_rasterization_depthalpha import GaussianRasterizationSettings, GaussianRasterizer
from diff_gaussian_rasterization_depthalpha.scene.cameras import PerspectiveCamera, OrthographicCamera

from diff_gaussian_rasterization_nusc import GaussianRasterizationSettings as GaussianRasterizationSettingsLabel
from diff_gaussian_rasterization_nusc import GaussianRasterizer as GaussianRasterizerLabel
...
def render(viewpoint_camera, pc, pipe, bg_color, delta_pose=None, render_type="rgb"):
    ...
    if render_type == "rgb":
        ...
        if colors_precomp.shape[-1] == 5:
            from diff_gaussian_rasterization_kitti import GaussianRasterizer as GaussianRasterizerLabel2
