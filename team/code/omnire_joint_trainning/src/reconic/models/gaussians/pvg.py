...
from .basics import dataclass_camera, dup_in_optim, quat_to_rotmat, remove_from_optim
...
class PeriodicVibrationGaussians(PeriodicVibrationGaussians_render, VanillaGaussians):
    def __init__(self, **kwargs):
        PeriodicVibrationGaussians_render.__init__(self, **kwargs)
        VanillaGaussians.__init__(self, **kwargs)
