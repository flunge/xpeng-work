...
import torch
import trimesh
from pytorch3d.transforms import axis_angle_to_matrix, matrix_to_quaternion, quaternion_to_matrix
...
from .modules import VoxelDeformer
...
class SMPLTemplate(nn.Module):
    ...
    def get_rot_action(self, axis_angle):
        ...
        I = torch.eye(3).to(R)[None].expand(B, -1, -1)  # B,3,3 # noqa: E741
