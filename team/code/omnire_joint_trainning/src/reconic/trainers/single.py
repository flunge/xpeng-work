...
# 根据环境变量动态选择模块
gs_mode = os.environ.get("GS_MODE", "").lower()
if gs_mode == "render":
    from ..models.gaussians import PeriodicVibrationGaussians_render as PeriodicVibrationGaussians
    from ..trainers.base_render import BasicTrainer_render as BasicTrainer
    from ..trainers.base_render import GSModelType
    print("Using modules_render for PeriodicVibrationGaussians_render BasicTrainer_render (GS_MODE=render)")
else:
    from ..models.gaussians import PeriodicVibrationGaussians
    from ..trainers.base import BasicTrainer, GSModelType
    print("Using modules for PeriodicVibrationGaussians BasicTrainer")
...
class SingleTrainer(BasicTrainer):
    ...
    def forward(
        ...
        normed_time = image_info.normalized_time
