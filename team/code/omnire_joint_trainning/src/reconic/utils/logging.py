...
from .misc import get_global_rank, is_enabled, is_main_process
...
class MetricLogger(object):
    ...
    def log_every(self, iterable, print_freq, header=None, 
                  n_iterations=None, start_iteration=0, start_engine_infer_at=40000):
        i = start_iteration
        if not header:
            header = ""
        ...
        for obj in iterable:
            ...
            if ((i % print_freq == 0 and i <= start_engine_infer_at) or 
                (i == n_iterations - 1) or 
                (i % (print_freq // 2) == 0 and i > start_engine_infer_at)):
