...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="training",
        help="split of the dataset, e.g. training, validation, testing, please specify the split name for different dataset",  # noqa: E501
    )
    parser.add_argument(
        "--target_dir",
        type=str,
    ...
    if args.dataset == "waymo":
        from .waymo.waymo_preprocess import WaymoProcessor
        ...
        from .pandaset.pandaset_preprocess import PandaSetProcessor
        ...
        from .argoverse.argoverse_preprocess import ArgoVerseProcessor
        ...
        from .nuscenes.nuscenes_preprocess import NuScenesProcessor
        ...
        from .kitti.kitti_preprocess import KittiProcessor
        ...
        from .nuplan.nuplan_preprocess import NuPlanProcessor
