...
OBJECT_TYPE = {
    ...
    "Emergency Vehicle": ObjectType.Vehicle,
    "Medium-sized Truck": ObjectType.Vehicle,
    "Motorcycle": ObjectType.Cyclist,
    "Motorized Scooter": ObjectType.Cyclist,
    "Other Vehicle - Construction Vehicle": ObjectType.Vehicle,
    "Other Vehicle - Pedicab": ObjectType.Cyclist,
    "Other Vehicle - Uncommon": ObjectType.Vehicle,
    "Pickup Truck": ObjectType.Vehicle,
    "Semi-truck": ObjectType.Vehicle,
    "Train": ObjectType.Vehicle,
    "Tram / Subway": ObjectType.Vehicle,
    # Humans (SMPL model)
    "Pedestrian": ObjectType.Pedestrian,
    "Pedestrian with Object": ObjectType.Pedestrian,
    # Potentially deformable objects
    "Bicycle": ObjectType.Cyclist,
    "Animals - Other": ObjectType.Other,
    "Personal Mobility Device": ObjectType.Other,
}
