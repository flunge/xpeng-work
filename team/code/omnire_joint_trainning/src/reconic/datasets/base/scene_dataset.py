...
class SceneDataset(abc.ABC):
    ...
    full_image_set: IterableSplitWrapper = None
    full_lidar_set: IterableSplitWrapper = None
    # train: includes only training data
    train_image_set: IterableSplitWrapper = None
    train_lidar_set: IterableSplitWrapper = None
    # test: includes only testing data
    test_image_set: IterableSplitWrapper = None
    test_lidar_set: IterableSplitWrapper = None
