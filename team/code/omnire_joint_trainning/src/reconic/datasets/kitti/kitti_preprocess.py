...
from ..kitti.trackletparser import parseXML
        ...
        for frame_idx in range(len(kitti_data)):
            for cam_idx, cam_name in enumerate(self.cam_list):
                ...
                for object in tracklets:
                    ...
                    h, w, l = object.size  # noqa: E741
                    corners_3d_local = get_corners(length=l, width=w, height=h)
            ...
            for cam_idx, cam_name in enumerate(self.cam_list):
                ...
                if len(obj_ids) == 0:
                    ...
                    for obj_id in obj_ids:
                        ...
                        l, w, h = box_size
                        corners = get_corners(length=l, width=w, height=h)
