<title>YED-DG100Wm</title>

# YED-DG100Wm

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/lel1lak86i0bnak2  
> 路径: 产品用户手册 > 4G DTU > YED-DG100Wm

# 简介

YED-DG100Wm是一款基于合宙Y100EPM系列高性价比的Cat1 4G DTU。支持移动、电信、联通 全网通4G，可以方便集成到自己的设备系统中。特性如下:

1. 支持5\~36V宽电压供电，支持电源防接反；
2. 工作环境为-35℃-75℃；
3. 支持1路RS485；
4. 支持1路RS232；
...
| 电源参数 |  | 5\~36V，10W电源，推荐12V电源，电源防插反 |
| 工作环境  | 工作温度 | -35℃ \~+75℃ |
| 工作湿度 | 5%\~95%RH(无凝露) |  |
...
|-|-|-|-|
| 编号 | 标识 | 功能 | 说明 |
| 1  | DC IN | 电源 | DC电源 5\~36V，10W电源，推荐12V电压 |
| 2 | VIN GND | 电源 | +表示电源正极/-表示电源负极，电源防插反 5\~36V，10W电源，推荐12V电压 |
| 3 | 4G天线 |  | SMA接口天线 |
| 4 | Reload |  | 长按7秒，恢复出厂设置 |
| 5 | SIM卡 |  | 自弹SIM卡，中卡，方向缺口朝外 |
| 6 | PWR | 指示灯 | 电源指示灯，供电常亮 |
| 7 | NET | 系统状态指示灯 |  |
| 8 | RDY | 系统状态指示灯 |  |
| 9 | TX RX GND |  | RS232接口 |
| 10 | A B |  | RS485接口 |
...
模块的VIN GND 接5\~36V,10W的电源(不能用USB转串口那种电脑USB供电，功率不足)；RS485 A接A，B接B；RS232接口TX 接USB 串口的RX，RX接USB串口的TX，GND接USB串口的GND。推荐使用银尔达的YED-UUART-211测试工具测试，方便供电和串口连接调试。
