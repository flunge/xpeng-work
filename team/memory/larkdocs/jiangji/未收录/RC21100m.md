<title>RC21100m</title>

# RC21100m

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/kw7t1fngscks9u9h  
> 路径: 产品用户手册 > 4G RTU > RC21100m
...
| 11 | TX RX GND |  | TTL串口 |
| 12 | 5V |  | 上电输出5V |
| 13 | GND DP DM VB |  | USB,固件升级或调试日志 |
| 14 | 4G天线 |  | SMA接口 |
| 15 | 外置SIM卡 |  | 翻盖卡槽，中卡，优先使用 |
| 16 | 内置SIM卡 |  | 无外置卡的时候使用 |
...
模块8\~36V供电；TTL接口，TX接RX，RX接TX。推荐使用银尔达的YED-UUART-211测试工具测试，方便供电和串口连接调试。
...
|  |  |  |  |
|-|-|-|-|
| 功能 | RC21100m | RN111 | 备注 |
| 芯片方案 | Air780EPM | Air724UG |  |
