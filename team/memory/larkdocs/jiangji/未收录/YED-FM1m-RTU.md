<title>YED-FM1m-RTU</title>

# YED-FM1m-RTU

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/igmxh3t1x47gmd02  
> 路径: 产品用户手册 > 4G RTU > YED-FM1m-RTU

# 简介

YED-FM1m RTU版本适合设备控制，状态检测等通过4G网络与服务器通讯的场景，具体功能特点如下。
...
| 可控电源 | 1路 | 3.3v输出 最大300MA |
| TTL串口 | 1路 | 3.3V电平，客户可以用 |
| 硬件看门狗 | 支持 | 外部硬件看门狗 |
| 尺寸 |  | 77\*48\*32mm |
| 安装方式 |  | 35mm导轨+螺丝定位孔 |
...
| 2 | TTL串口 |  | 产测串口，3.3V电平，客户可以用 |
| 3 | 3.3V | 可控电源 | 输出3.3V 最大300MA |
| 4 | USB |  | 固件升级或调试日志 |
| 5 | 4G天线 |  | SMA接口 |
| 6 | Reload |  | 长按7秒，恢复出厂设置 |
| 7 | BOOT |  | 与USB配合用来升级 |
| 8 | NO/COM/NC | 继电器 | 默认COM（公共端）与NC(常闭)导通/打开后COM与NO（常开）导通 250VAC 10A/28VDC 10A |
| 9 | IN1 IN2 GND | 输入检查 | GND与IN1、IN2 导通，触发输入;  |
| 10 | NET |  | 系统指示灯 |
| 11 | RELAY | 继电器指示灯 | 打开继电器，常亮 |
| 12 | 内置SIM卡 |  | 贴片卡 |
| 13 | 外置SIM卡 |  | 直插自弹卡槽，小卡 |
