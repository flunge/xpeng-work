<title>YED-D700Tm</title>

# YED-D700Tm

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/ic2s70um4zdcq836  
> 路径: 产品用户手册 > 4G DTU > YED-D700Tm

# 简介

YED-D700Tm DTU是由银尔达（yinerda）推出的工业级的4G Cat1 DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，特性如下:

1. 支持直流8\~90V宽电压供电，支持电源防接反；
2. 支持接触放电±8KV，空气放电±15KV；
3. 工作环境为-35℃-75℃；
4. 支持3路RS485,RS485_1 EN软件翻转，RS485_2/RS485_3 EN硬件翻转。
5. 支持1路ADC采集供电电压；
6. 支持1路可控电源输出供电电压；
...
| 电源参数 |  | 8\~90V，10W电源，推荐10V以上电源 自带1路ADC采集供电电压 |
| 工作环境  | 工作温度 | -35℃ \~+75℃ |
| 工作湿度 | 5%\~95%RH(无凝露) |  |
| RS485串口 | 3路 | RS485_1:1200-230400；数据位:8 ；停止位：1、2；校验位：奇、偶、无校验 RS485_2/RS485_3:1200-460800；数据位:8 ；停止位：1、2；校验位：奇、偶、无校验 |
| ADC | 1路 | 只支持供电电压采集 |
...
|-|-|-|-|
| 编号 | 标识 | 功能 | 说明 |
| 1 | VIN/GND | 电源 | VIN电源正极，GND电源负极 范围8\~90V，10W电源 自带1路ADC采集供电电压 |
| OV |  | 可控电源输出 |  |
| A1/B1 | RS485 | RS485_1 |  |
| A2/B2 | RS485 | RS485_2 |  |
| A3/B3 | RS485 | RS485_3 |  |
...
| 4 | VB DM DP GND | USB | 升级固件和调试日志 2.54mm间距USB排针，VB是+ GND是- 不能接反，否则会烧毁设备 |
| 5 | Reload |  | 长按7秒，恢复出厂设置 |
| 6 | 天线 |  | 4G天线，SMA螺旋内针 |
| 7 | 内置SIM卡 |  | 贴片SIM卡 |
| 8 | 外置SIM卡 |  | 自弹SIM卡，中卡，方向缺口朝外 |

注意USB和BOOT放到内部，如果需要二次开发和日志调试需要拆开外壳。
...
模块的VIN GND 接8\~90V,10W的电源(不能用USB转串口那种电脑USB供电，功率不足)；RS485 A接A，B接B；推荐使用银尔达的YED-UUART-211测试工具测试，方便供电和串口连接调试。
