<title>MQTT远程控制DTU资源实例</title>

# MQTT远程控制DTU资源实例

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/bfwt0kufgud2ahbz  
> 路径: DTU固件实例讲解 > MQTT远程控制DTU资源实例
...
打开DTU测试平台:[http://test.yinerda.com](http://test.yinerda.com)，选择“MQTT测试工具”，点击"打开"，可以获取到MQTT测试IP地址/域名 和端口号，登录客户端ID，登录用户名，登录密码。 IP地址或者域名就是MQTT的服务器地址，任选其一。
