<title>G2100W-E</title>

# G2100W-E

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/ng34moigta0ud8uv  
> 路径: 产品用户手册 > 定位模块 > G2100W-E

# 简介

G2100W-E核心板是由银尔达（yinerda）推出的工业级的单串口DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景。
...
|-|-|-|-|
| 编号 | 标识 | 功能 | 说明 |
| 1 | VIN GND | 电源正 电源负 | VIN表示正极，GND表示负极 供电范围：8\~90V，10W电源 |
| 2 | RX TX | RS232串口 |  |
| 3 | A B | RS485串口 |  |
| 4 | 外置SIM卡 |  | 翻盖小卡 |
| 5 | NET LED |  | 系统指示灯 |
| 6 | 1PPSLED | GPS指示灯 | GPS定位成功 1s闪烁 |
| 7 | 4G | 4G天线 | SMA螺旋内针 |
| 8 | GPS | GPS天线 | SMA螺旋内针 |
| 9 | USB | 固件升级或者调试 | USB |
| 10 | BOOT |  | 与USB配合用来升级 |
| 11 | Reload |  | 长按7秒，恢复出厂设置 |
| 12 | 贴片SIM卡 |  | 贴片SIM卡稳定，不松动，脱落，整个板子可以喷三防漆，缺点是不能跟换卡 |
| 13 | GPS模块 |  | 可选GPS模块ATGM336H-5NR32或ATGM336H-6N22单北斗芯片 |
