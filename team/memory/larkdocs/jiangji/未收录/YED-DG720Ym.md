<title>YED-DG720Ym</title>

# YED-DG720Ym

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/nu5z6m9g2u8yf1ox  
> 路径: 产品用户手册 > 4G DTU > YED-DG720Ym

# 简介

YED-DG720Ym DTU是由银尔达（yinerda）推出的工业级的单RS485串口DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，特性如下:
...
15)Air780EPM方案，内存4M，4路网络通道，串口缓存8K 。
...
模块的VIN GND 接5\~36V,10W的电源(不能用USB转串口那种电脑USB供电，功率不足)；RS485 A接A，B接B；推荐使用银尔达的YED-UUART-211测试工具测试，方便供电和串口连接调试。
