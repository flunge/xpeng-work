<title>YED-SW1002M-10</title>

# YED-SW1002M-10

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/beiehs9yao0ubi46  
> 路径: 产品用户手册 > 4G RTU > YED-SW1002M-10

# 简介

YED-SW1002M-10-RTU版本适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，具体功能特点如下。
...
| 输入 | 2路 | 光耦隔离，干接点输入 |
| 输出 | 2路 | 继电器，220VAC 10A/30VDC 10A |
...
| 2 | NO/COM/NC | 继电器 | 默认COM（公共端）与NC(常闭)导通/打开后COM与NO（常开）导通 220VAC 10A /30VDC 10A |
| 3 | NET |  | 系统指示灯 |
| 4 | USB |  | 固件升级或调试日志 |
| 5 | BOOT |  | 与USB配合用来升级 |
| 6 | Reload |  | 长按7秒，恢复出厂设置 |
| 7 | ４G天线 |  | SMA接口 |
| 8 | AI1/AI2 |  | 默认采集0-20ma电流 可以通过修改电阻，切换电压采集 |
| 9 | IN1/IN2/COM | 干接点输入 | COM与IN 导通，触发输入，COM的电压等于输入电压 |
| 10 | A/B | RS485串口 | RS485串口 |
| 11 | RTC |  | RTC时钟 |
| 12 | 内置SIM卡 |  | 无外置卡的时候使用 |
...
# YED-SW1002P-10与YED-RY22202区别

|  |  |  |  |
|-|-|-|-|
| 功能 | YED-SW1002P-10 | YED-RY22202 | 备注 |
| 芯片方案 | Air780EP/Y100EP | Air780E |  |
| TTS接口 | 不支持 | 支持 | RY22202基本没用 需要二次开发 |
| 继电器状态指示灯 | 不支持 | 支持 |  |
| LED形状 | 直插灯柱 | 贴片LED |  |
| 供电电压采集 | 支持 | 不支持 |  |
| 本地RTC时钟 | 支持 | 不支持 |  |