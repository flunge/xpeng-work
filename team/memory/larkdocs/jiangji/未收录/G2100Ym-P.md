<title>G2100Ym-P</title>

# G2100Ym-P

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/ot7a0u5dedxovd0n  
> 路径: 产品用户手册 > 定位模块 > G2100Ym-P

# 简介

G2100Y-P核心板是由银尔达（yinerda）推出的工业级的单串口DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景。
