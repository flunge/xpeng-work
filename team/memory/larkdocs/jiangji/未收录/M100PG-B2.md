<title>M100PG-B2 </title>

# M100PG-B2

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/dwg0gfubwgts7tvg  
> 路径: 产品用户手册 > 定位模块 > M100PG-B2

# 简介

YED-M100PG-B DTU是由银尔达（yinerda）推出的工业级的单TTL串口DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景。
...
| 6 | 4G天线 |  | IPEX 1代，必须接 |
| 7 | VIN GND | 电源 | VIN表示正极，GND表示负极 供电范围：5\~12V（10W） |
...
| 8 | BOOT按键 |  | 强制升级按键；按下按键，再上电设备，模组进入下载模式 |
