<title>YED-SW1004v-10</title>

# YED-SW1004v-10

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/cacigs479uuwfpwv  
> 路径: 产品用户手册 > 4G RTU > YED-SW1004v-10

# 简介

YED-SW1004v-10版本适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，具体功能特点如下
...
| 工作环境  | 工作温度 | -35℃ \~+75℃ |
| 工作湿度 | 5%\~95%RH(无凝露) |  |
| RS485串口 | 2路 | 1200-230400；数据位:8、7 ；停止位：1、2；校验位：奇、偶、无校验 |
| 输入 | 4路 | 光耦隔离，干接点输入 |
| 输出 | 4路 | 继电器，250VAC 10A/28VDC 10A |
...
| 2 | IN1-IN4 COM | 干接点输入 | COM与IN 导通，触发输入，COM的电压等于输入电压 |
| 3 | OUT GND |  | 可控电源输出，输出供电电压，电流1A (doout,5,1) |
| 4 | A1/B1 A2/B2 | RS485串口 | RS485串口 |
| 5 | 4G天线 |  | SMA接口 |
| 6 | MIC+ MIC- |  | 咪头 |
| 7 | SPK+ SPK- |  | TTS喇叭 4欧3w |
| 8 | Reload |  | 长按7秒，恢复出厂设置 |
| 9 | BOOT |  | 与USB配合用来升级 |
| 10 | USB |  | 固件升级或调试日志 |
| 11 | NET |  | 系统指示灯 |
| 12 | 外置SIM卡 |  | 翻盖卡槽，中卡，优先使用 |
| 13 | 继电器1-4 | 继电器 | 默认COM（公共端）与NC(常闭)导通/打开后COM与NO（常开）导通 250VAC 10A /28VDC 10A |
| 14 | 内置SIM卡 |  | 无外置卡的时候使用 |
...
模块8\~36V供电；RS485接口，A接Ａ，B接B。推荐使用银尔达的YED-UUART-211测试工具测试，方便供电和串口连接调试。
...
# YED-SW1004v-10与YED-SW1004P-10区别

|  |  |  |  |
|-|-|-|-|
| 功能 | YED-SW1004v-10 | YED-SW1004P-10 | 备注 |
| 芯片方案 | Air780EHV | Air780EP/Y100EP |  |
...
# YED-SW1004v-10与YED-RY1440区别

|  |  |  |  |
|-|-|-|-|
| 功能 | YED-SW1004v-10 | YED-RY1440 | 备注 |
