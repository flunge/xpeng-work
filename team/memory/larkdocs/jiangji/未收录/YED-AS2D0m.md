<title>YED-AS2D0m</title>

# YED-AS2D0m

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/byah8v95lxl80t1c  
> 路径: 产品用户手册 > 4G RTU > YED-AS2D0m

# 简介

YED-AS2D0m RTU是由银尔达（yinerda）推出的高性价的远程控制器，适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，特性如下:
...
| IN1 COM IN2 COM | 输入检测 | IN 和 COM 导通触发 | 默认IN和COM导通，触发 |  |
| 2 | USB |  | 用来调试或者固件升级。 |  |
| 3 | TTL串口 |  | 产测串口 |  |
