<title>WebSocket配置测试实例</title>

# WebSocket配置测试实例

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/lht1n1waqugwxbd0  
> 路径: DTU固件实例讲解 > WebSocket配置测试实例
...
打开DTU测试平台:[http://test.yinerda.com](http://test.yinerda.com)，选择“WebSocket测试工具”，点击"打开"，可以获取到web测试IP地址/域名 和端口号。 IP地址或者域名就任选其一。
