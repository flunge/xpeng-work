<title>YED-D100L1-Ym2</title>

# YED-D100L1-Ym2

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/kk57uwq1i9gbycd5  
> 路径: 产品用户手册 > 4G DTU > YED-D100L1-Ym2

# 简介

YED-D100L1-Ym2 DTU是由银尔达（yinerda）推出的高性价的低功耗DTU，适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景，特性如下:
...
注意YED-D100L1-Y与YED-D100L1-Ym2相同，前置是Air780EP方案，后置是Air780EPM方案。DTU用户使用方法一样。
...
| 电源参数 |  | 5\~36V，10W电源，推荐12V电压 支持供电电压采集 |
| 工作环境  | 工作温度 | -35℃ \~+75℃ |
| 工作湿度 | 5%\~95%RH(无凝露) |  |
| RS485 | 1路 | 1200-230400；数据位:8、7；停止位：1、2；校验位：奇、偶、无校验 |
| 可控电源输出 | 1路 | 输出供电电压，最大电流1A |
| 数字量输入 | 2路 | 支持2\~36V高电平检测 |
...
|-|-|-|-|
| 编号 | 标识 | 功能 | 说明 |
| 1 | VIN GND | 供电电源 | VIN表示电源正极，GND表示电源负极 5\~36V，10W，推荐12V电压 支持供电电压采集 |
| VOUT | 可控电源输出 | 输出供电电源电压，最大电流1A |  |
| IN1 IN2 | 数字量输入 | 检测范围2\~36V，可以做超低功耗唤醒 |  |
| AIV |  | 0\~36V电压采集，可以切换电路采集电流 |  |
...
# YED-D100L1-Ym2与YED-D780L1-Y与YED-D100L1-Ym2区别

|  |  |  |  |  |
|-|-|-|-|-|
| 功能 | D100L1-Ym2 | D100L1-Ym | D780L1-Y | 备注 |
| 芯片方案 | Air780EPM/Y100EPM | Air780EPM/Y100EPM | Air780E |  |
| 供电电压采集 | 支持(0\~36V供电电压采集) | 支持(0\~36V供电电压采集) | 不支持 |  |
| RS485方案 | RS485硬件软件反转 | RS485硬件自动反转 | RS485软件翻转 | 解决有的设备设备翻转太快数据接收不全问题 |
| 12V 供电超低待机功耗 | 超低功耗48ua | 超低功耗48ua | 超低功耗150ua |  |