<title>YED-U100U（短信处理）</title>

# YED-U100U（短信处理）

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/isdw7d9yecop39oi  
> 路径: 产品用户手册 > 4G网卡 > YED-U100U（短信处理）

# 简介

U100U 核心板是由银尔达（yinerda）基于合宙Air780EP模组推出的USB供电DTU 。小巧、稳定、可靠。能够把接收网络数据、短信自动发送到目标服务器。
