<title>M100PG-C1 </title>

# M100PG-C1

> 来源: https://yinerda.yuque.com/yt1fh6/4gdtu/kityhvlxwrb8rrlf  
> 路径: 产品用户手册 > 定位模块 > M100PG-C1

# 简介

YED-M100PG-C1 DTU是由银尔达（yinerda）推出的工业级的单TTL串口DTU 。小巧、稳定、可靠。适合设备控制，状态检测，传感器数据采集等通过4G网络与服务器通讯的场景。
...
| 6 | VIN GND | 电源 | VIN表示正极，GND表示负极 供电范围：3.3\~4.2V（10W） |
